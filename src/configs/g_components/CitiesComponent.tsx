import { AccordionDetails, Checkbox, CircularProgress, FormControlLabel, FormGroup, Grid, TextField } from '@mui/material';
...
setTimeout(()=>{setCitySearch(e.target.value)},400)
  }
